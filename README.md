...
Live: **https://baditaflorin.github.io/mesh-potluck/**

Source: **https://github.com/baditaflorin/mesh-potluck**
...
git clone https://github.com/baditaflorin/mesh-potluck
cd mesh-potluck
npm install
npm run dev
```
...
- `mesh-potluck:signalingUrl`
- `mesh-potluck:turnTokenUrl`
- `mesh-potluck:iceServers`
- `mesh-potluck:room`
